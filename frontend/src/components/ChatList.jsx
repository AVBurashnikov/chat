...
export const ChatList = ({ selectedId, onSelect }) => {
  ...
  const createChatMutation = useMutation({
    ...
    onError: (error) => {
      ...
      setFormError(
        backendMessage || "Не удалось создать чат. Проверь username."
      );
    },
  });
  ...
  const handleCreateChat = (e) => {
    ...
    if (!participantUsername.trim()) {
      setFormError("Введите username собеседника.");
      return;
    }
  ...
  return (
    ...
    >
      ...
      {/* Список чатов с кнопкой удаления */}
